...
Sub stockAnalysis():
    ...
    For Each ws In Worksheets
        ...
        ' find the last data in the extra rows from the columns J-L
        ...
        ' use Match() to find the rows numbers of the ticker names associated with the greatest % increase and decrease, then find the greatest total stock vol
